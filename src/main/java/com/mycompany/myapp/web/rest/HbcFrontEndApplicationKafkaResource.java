...
@RestController
@RequestMapping("/api/hbc-front-end-application-kafka")
public class HbcFrontEndApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HbcFrontEndApplicationKafkaResource.class);
    ...
    public HbcFrontEndApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
